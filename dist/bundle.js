...
var scratchCanvas = document.getElementById('canvas_scratch');
var scratchContext = scratchCanvas.getContext('2d');

var bestCanvas = document.getElementById('canvas_best');
var bestContext = bestCanvas.getContext('2d');
...
var scratch = {
  ...
  getWidth: function getWidth() {
    return scratchCanvas.width;
  },
  getHeight: function getHeight() {
    return scratchCanvas.height;
  }
};
...
var best = {
  ...
  getWidth: function getWidth() {
    return bestCanvas.width;
  },
  getHeight: function getHeight() {
    return bestCanvas.height;
  }
};
...
var arrayPush = __webpack_require__(35),
    ...
    getSymbols = __webpack_require__(16),
    stubArray = __webpack_require__(33);
...
function updateImprovementsDisplay(i) {
  updateDisplay('desc_improvements', 'improvements: ' + i);
}

function updateGenerationsDisplay(g) {
  updateDisplay('desc_generations', 'generations: ' + g);
}

function updateBestSimilarityDisplay(s) {
  updateDisplay('best_desc_similarity', s + '% similar');
}

function updateScratchSimilarityDisplay(s) {
  updateDisplay('scratch_desc_similarity', s + '% similar');
}

function updateScratchPhaseIdDisplay(id, n) {
  updateDisplay('scratch_desc_phasenum', 'phase: ' + (id + 1) + ' / ' + n);
}

function updateScratchTemperatureDisplay(t) {
  updateDisplay('scratch_desc_temp', 'temperature: ' + t);
}

function updateScratchPhasePercentageDisplay(tries, max) {
  var percentDone = (100 * tries / max).toFixed();
  updateDisplay('scratch_desc_phase_percentage', 'phase progress: ' + percentDone + '%');
}
...
exports.updateImprovementsDisplay = updateImprovementsDisplay;
exports.updateGenerationsDisplay = updateGenerationsDisplay;
exports.updateBestSimilarityDisplay = updateBestSimilarityDisplay;
exports.updateScratchSimilarityDisplay = updateScratchSimilarityDisplay;
exports.updateScratchPhaseIdDisplay = updateScratchPhaseIdDisplay;
exports.updateScratchTemperatureDisplay = updateScratchTemperatureDisplay;
exports.updateScratchPhasePercentageDisplay = updateScratchPhasePercentageDisplay;
...
var _similarity = __webpack_require__(42);

var _mutate = __webpack_require__(44);

var _toImg = __webpack_require__(122);

var _randomState = __webpack_require__(123);

var _draw = __webpack_require__(131);

var _display = __webpack_require__(39);

var _constants = __webpack_require__(18);

var drawScratch = function drawScratch() {
  return (0, _draw.drawAll)(scratchState, 0);
};
var drawBest = function drawBest() {
  return (0, _draw.drawAll)(bestState, 1);
};

var scratchState = (0, _randomState.randomState)();
var bestState = scratchState;
var bestFitness = 0;
...
drawScratch();
drawBest();
(0, _display.updateGenerationsDisplay)(0);
requestAnimationFrame(newGeneration);

setInterval(function () {
  return (0, _display.updateGenerationsDisplay)(generations);
}, 1500);
...
function newGeneration() {
  ...
  generations++;
  scratchState = (0, _mutate.mutate)(bestState);
  drawScratch();

  (0, _similarity.getSimilarityAsPercentage)(_constants.IMG_PATH, (0, _toImg.workingCanvas)()).then(function (similarity) {
    if (similarity > bestFitness) {
      foundNewBest(similarity);
    }
    (0, _display.updateScratchSimilarityDisplay)(similarity);
    requestAnimationFrame(newGeneration);
  });
}
...
function foundNewBest(similarity) {
  ...
  drawBest();
  (0, _mutate.phaseFoundNewBest)();
  (0, _display.updateImprovementsDisplay)(improvements);
  (0, _display.updateBestSimilarityDisplay)(bestFitness);
}
...
Math.interpolate = function (domain, range, value) {
	...
	var result = y1 + (y2 - y1) * (value - x1) / (x2 - x1);
...
Math.interpolateSmooth = function (domain, range, value) {
	...
	var sinArg = period * (value - x1) - Math.PI_half;
	var result = Math.interpolate([-1, 1], [y1, y2], Math.sin(sinArg));
	return Math.bound(min, max, result);
};
...
exports.getSimilarityAsPercentage = undefined;

var _resemblejs = __webpack_require__(43);

var _resemblejs2 = _interopRequireDefault(_resemblejs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var format = function format(mismatch) {
  return (100 - Number(mismatch)).toFixed(2);
};

var getSimilarityAsPercentage = function getSimilarityAsPercentage(file1, file2) {
  return new Promise(function (resolve, reject) {
    (0, _resemblejs2.default)(file1).compareTo(file2).scaleToSameSize().ignoreColors().onComplete(function (data) {
      return resolve(format(data.misMatchPercentage));
    });
  });
};

exports.getSimilarityAsPercentage = getSimilarityAsPercentage;
...
exports.phaseFoundNewBest = exports.mutate = undefined;

var _clone = __webpack_require__(45);

var _clone2 = _interopRequireDefault(_clone);

var _phase = __webpack_require__(121);
...
function mutate(lines) {
  ...
  var newLines = (0, _clone2.default)(lines);
...
function mutateLine(l) {
  if (_phase2.default.isFinished) {
    ...
    return {
      x1: l.x1 + Math.randomInRange(-_phase2.default.temp, _phase2.default.temp),
      y1: l.y1 + Math.randomInRange(-_phase2.default.temp, _phase2.default.temp),
      x2: l.x2 + Math.randomInRange(-_phase2.default.temp, _phase2.default.temp),
      y2: l.y2 + Math.randomInRange(-_phase2.default.temp, _phase2.default.temp)
    };
  }
}
...
exports.phaseFoundNewBest = phaseFoundNewBest;
...
var cloneArrayBuffer = __webpack_require__(17),
...
var phase = {
  ...
  beginNew: function beginNew() {
    this.tries = -1;
    this.id++;
    if (this.id >= _constants.N) {
      this.id = 0;
    }
    this.isFinished = false;
    (0, _display.updateScratchPhaseIdDisplay)(this.id, _constants.N);
  },
  step: function step() {
    this.tries++;
    this.isFinished = this.tries > _constants.MAX_TRIES;
...
exports.workingCanvas = undefined;

var _canvas = __webpack_require__(19);

var ctx = _canvas.scratch.getContext();
var width = _canvas.scratch.getWidth();
var height = _canvas.scratch.getHeight();

var workingCanvas = function workingCanvas() {
  return ctx.getImageData(0, 0, width, height);
};

exports.workingCanvas = workingCanvas;
...
exports.randomState = undefined;

var _times = __webpack_require__(124);
...
var randomState = function randomState() {
  return (0, _times2.default)(_constants.N, function () {
    return {
